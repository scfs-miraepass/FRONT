...
<!--        <div class="flex gap-2" v-if="isConfirm">-->
<!--            <UButton class="rounded-2xl justify-center flex-1" color="neutral" variant="soft" :disabled="busy" @click="isConfirm = false">-->
<!--                취소-->
<!--            </UButton>-->
...
<!--            </UButton>-->
<!--        </div>-->
<!--        <UButton v-else class="rounded-2xl justify-center flex" color="error" variant="soft" @click="isConfirm = true">-->
<!--            파티 해산하기-->
<!--        </UButton>-->
<!--    </template>-->
<!--    <UButton v-else class="rounded-2xl justify-center flex" color="error" variant="soft" :loading="busy" @click="">-->
<!--        파티 나가기-->
<!--    </UButton>-->
</template>
