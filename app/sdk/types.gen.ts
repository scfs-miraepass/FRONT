 ...
 * PointHistoryType
 */
export type PointHistoryType = 'teacher' | 'cafe' | 'food' | 'etc' | 'grant' | 'quest';
...
/**
 * ResponseModel[List[Quest]]
 */
export type ResponseModelListQuest = {
    /**
     * Success
     */
    success: boolean;
 ...
 * ResponseModel[Quest]
 */
export type ResponseModelQuest = {
    /**
     * Success
     */
    success: boolean;
