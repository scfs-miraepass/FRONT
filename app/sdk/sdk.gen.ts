 ...
 * 수락 취소
 *
 * 학생이 자신이 수락한 퀘스트를 취소합니다.
 */
export const cancelAcceptQuestQuestIdAcceptDelete = <ThrowOnError extends boolean = false>(options: Options<CancelAcceptQuestQuestIdAcceptDeleteData, ThrowOnError>): RequestResult<CancelAcceptQuestQuestIdAcceptDeleteResponses, CancelAcceptQuestQuestIdAcceptDeleteErrors, ThrowOnError> => (options.client ?? client).delete<CancelAcceptQuestQuestIdAcceptDeleteResponses, CancelAcceptQuestQuestIdAcceptDeleteErrors, ThrowOnError>({ url: '/quest/{quest_id}/accept', ...options });

/**
 * 내 수락 여부
 *
 * 현재 로그인한 사용자가 해당 퀘스트를 수락했는지 여부를 반환합니다.
 */
export const myAcceptStatusQuestQuestIdAcceptGet = <ThrowOnError extends boolean = false>(options: Options<MyAcceptStatusQuestQuestIdAcceptGetData, ThrowOnError>): RequestResult<MyAcceptStatusQuestQuestIdAcceptGetResponses, MyAcceptStatusQuestQuestIdAcceptGetErrors, ThrowOnError> => (options.client ?? client).get<MyAcceptStatusQuestQuestIdAcceptGetResponses, MyAcceptStatusQuestQuestIdAcceptGetErrors, ThrowOnError>({ url: '/quest/{quest_id}/accept', ...options });
 ...
 * 학생이 퀘스트를 수락합니다.
 */
export const acceptQuestQuestQuestIdAcceptPost = <ThrowOnError extends boolean = false>(options: Options<AcceptQuestQuestQuestIdAcceptPostData, ThrowOnError>): RequestResult<AcceptQuestQuestQuestIdAcceptPostResponses, AcceptQuestQuestQuestIdAcceptPostErrors, ThrowOnError> => (options.client ?? client).post<AcceptQuestQuestQuestIdAcceptPostResponses, AcceptQuestQuestQuestIdAcceptPostErrors, ThrowOnError>({ url: '/quest/{quest_id}/accept', ...options });

/**
 * 수락한 학생 목록
 *
 * 퀘스트를 수락한 학생들의 목록을 조회합니다. (퀘스트 생성자 또는 교사 전용)
 */
export const listAcceptedStudentsQuestQuestIdAcceptedGet = <ThrowOnError extends boolean = false>(options: Options<ListAcceptedStudentsQuestQuestIdAcceptedGetData, ThrowOnError>): RequestResult<ListAcceptedStudentsQuestQuestIdAcceptedGetResponses, ListAcceptedStudentsQuestQuestIdAcceptedGetErrors, ThrowOnError> => (options.client ?? client).get<ListAcceptedStudentsQuestQuestIdAcceptedGetResponses, ListAcceptedStudentsQuestQuestIdAcceptedGetErrors, ThrowOnError>({ url: '/quest/{quest_id}/accepted', ...options });
 ...
 */
export const getUserStampsStampGet = <ThrowOnError extends boolean = false>(options?: Options<GetUserStampsStampGetData, ThrowOnError>): RequestResult<GetUserStampsStampGetResponses, GetUserStampsStampGetErrors, ThrowOnError> => (options?.client ?? client).get<GetUserStampsStampGetResponses, GetUserStampsStampGetErrors, ThrowOnError>({ url: '/stamp', ...options });
