...
import KaraokeManage from "@/components/home/section/karaokeManage.vue";
...
const sectionItem = computed(() => {
    ...
    if (hasPermission(permissions, UserPermission.MANAGE_KARAOKE)) items.push(KaraokeManage)
