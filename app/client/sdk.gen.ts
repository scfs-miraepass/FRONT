...
export class MiraepassApi extends HeyApiClient {
     ...
     * 학생 주간 포인트 랭킹 조회
     *
     * KST 기준 현재 주의 순증감 포인트를 기준으로 학생 랭킹을 조회합니다.
     */
    public getWeeklyStudentRankingPointRankingWeeklyStudentGet<ThrowOnError extends boolean = false>(options?: Options<GetWeeklyStudentRankingPointRankingWeeklyStudentGetData, ThrowOnError>): RequestResult<GetWeeklyStudentRankingPointRankingWeeklyStudentGetResponses, GetWeeklyStudentRankingPointRankingWeeklyStudentGetErrors, ThrowOnError> {
        return (options?.client ?? this.client).get<GetWeeklyStudentRankingPointRankingWeeklyStudentGetResponses, GetWeeklyStudentRankingPointRankingWeeklyStudentGetErrors, ThrowOnError>({
            requestValidator: async (data) => await z.object({
                body: z.never().optional(),
                path: z.never().optional(),
                query: zGetWeeklyStudentRankingPointRankingWeeklyStudentGetQuery.optional()
            }).parseAsync(data),
            responseTransformer: async (data) => await zGetWeeklyStudentRankingPointRankingWeeklyStudentGetResponse.parseAsync(data),
     ...
     * 교사 주간 포인트 랭킹 조회
     *
     * KST 기준 현재 주의 순증감 포인트를 기준으로 교사 랭킹을 조회합니다.
     */
    public getWeeklyTeacherRankingPointRankingWeeklyTeacherGet<ThrowOnError extends boolean = false>(options?: Options<GetWeeklyTeacherRankingPointRankingWeeklyTeacherGetData, ThrowOnError>): RequestResult<GetWeeklyTeacherRankingPointRankingWeeklyTeacherGetResponses, GetWeeklyTeacherRankingPointRankingWeeklyTeacherGetErrors, ThrowOnError> {
        return (options?.client ?? this.client).get<GetWeeklyTeacherRankingPointRankingWeeklyTeacherGetResponses, GetWeeklyTeacherRankingPointRankingWeeklyTeacherGetErrors, ThrowOnError>({
            requestValidator: async (data) => await z.object({
                body: z.never().optional(),
                path: z.never().optional(),
                query: zGetWeeklyTeacherRankingPointRankingWeeklyTeacherGetQuery.optional()
            }).parseAsync(data),
            responseTransformer: async (data) => await zGetWeeklyTeacherRankingPointRankingWeeklyTeacherGetResponse.parseAsync(data),
