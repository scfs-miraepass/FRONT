...
export class MiraepassApi extends HeyApiClient {
     ...
     * 포인트 랭킹 조회
     *
     * 유저 타입과 기간을 기준으로 포인트 랭킹을 조회합니다.
     */
    public getRankingPointRankingGet<ThrowOnError extends boolean = false>(options?: Options<GetRankingPointRankingGetData, ThrowOnError>): RequestResult<GetRankingPointRankingGetResponses, GetRankingPointRankingGetErrors, ThrowOnError> {
        return (options?.client ?? this.client).get<GetRankingPointRankingGetResponses, GetRankingPointRankingGetErrors, ThrowOnError>({
            requestValidator: async (data) => await z.object({
                body: z.never().optional(),
                path: z.never().optional(),
                query: zGetRankingPointRankingGetQuery.optional()
            }).parseAsync(data),
            responseTransformer: async (data) => await zGetRankingPointRankingGetResponse.parseAsync(data),
            url: '/point/ranking',
            ...options
        });
    }
